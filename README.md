...
* **Duration:** 08 Dec 2025 – 23 Jan 2026
...
```
Elevate-Labs/
 ├── Elevate_Labs_Task_1/  → Data Analysis & EDA
 ├── Elevate_Labs_Task_2/  → Power BI Dashboard
 ├── Elevate_Labs_Task_3/  → SQL Queries & Analysis
 ├── Elevate_Labs_Task_4/  → Sales Dashboard & Presentation
 ├── Elevate_Labs_Task_5/  → Machine Learning (Titanic Dataset)
 ├── Elevate_Labs_Task_6/  → SQL + Excel Analysis
 ├── Elevate_Labs_Task_7/  → SQL in Python
```
...
* Performed data transformations and feature exploration
...
* Created KPIs, filters, and visual reports
...
* Derived insights from e-commerce data
...
* Practical exposure to SQL, dashboards, and ML basics
* Ability to derive insights and present findings clearly
